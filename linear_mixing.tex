...
\chapter[Accelerated ZO Mirror Descent]
...
\begin{lemma}[Regret Bound]
    ...
    On $\bigcap \mathfrak B_t \cap \mathfrak O_t \cap \mathfrak P_t \cap \mathfrak G_t \cap \mathfrak M_t$, we have
    \begin{align*}
...
\begin{lemma}[Energy Bound]
    On $\bigcap \mathfrak B_t \cap \mathfrak O_t \cap \mathfrak P_t \cap \mathfrak G_t \cap \mathfrak M_t$, upon defining $M = \sup_{0 \leq t \leq T-1} V_{z_t}(x^*)$, choosing the slack $\gamma = 8$ and letting $\Theta \geq V_{z_0}(x^*)$ be any upper bound, we have
    \begin{align*}
...
\begin{theorem}[Halving Function Decrease]
    Assuming the initial error $f(y_0) - f^* \leq \Delta$, by choosing
    \begin{align*}
        \eta = \frac{r}{4CLd \chi}, \qquad \alpha = \frac{r}{16 C d\chi} \sqrt{\frac{\Theta}{L\Delta}}
    \end{align*}
    In 
    \begin{align*}
        T=\frac{256 C d \chi}{r} \sqrt{\frac{L\Theta}{\Delta}}
    \end{align*} iterations we have $f(\bar x) - f^* \leq \Delta/2$ with probability at least $1-5\delta$.
\end{theorem}
\begin{proof}
    On $\bigcap \mathfrak B_t \cap \mathfrak O_t \cap \mathfrak P_t \cap \mathfrak G_t \cap \mathfrak M_t$ all our previous lemmas hold. Each has probability at least $1-\delta$ so the intersection of 5 has probability at least $1-5\delta$. 
    ...
    \begin{align*}
        T(f(\bar x)-f^*) \leq \sum_{t=0}^{T-1} (f(x_t)-f^*) \leq \sum_{t=0}^{T-1} \langle \grad f(x_t), x_t-x^* \rangle
    \end{align*}
    ...
    \begin{align*}
        f(\bar x) - f^* \leq \frac{512 C^2 d^2 L \chi^2 \alpha \Delta}{r^2 T} + \frac{2\Theta}{\alpha T} + \frac{C'(\alpha + T) L^3 \sigma^2 \chi^5 d^5}{r^2}
    \end{align*}
    By choosing 
    \begin{align*}
